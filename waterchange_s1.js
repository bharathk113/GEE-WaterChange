...
function processPeriod(startyear,startmonth,endyear,endmonth,tabletouse){
...
var period1_startyear=2020
var period1_startmonth=12
var period1_endyear=2020
var period1_endmonth=12

var period2_startyear=2021
var period2_startmonth=5
var period2_endyear=2021
var period2_endmonth=5

var water_period1=processPeriod(period1_startyear,period1_startmonth,period1_endyear,period1_endmonth,tabletouse)
...
var sum1_period1 = sum_period1.gt(misClasThres).selfMask()
print (sum1_period1)
var sum1_period1 = sum1_period1.where(sum1_period1.gt(0), -1)
Map.addLayer(sum1_period1, {palette: 'F000FF'}, "sum1_period1");
var water_period2=processPeriod(period2_startyear,period2_startmonth,period2_endyear,period2_endmonth,tabletouse)
...
print ("Check this value and use approximately 5%-10% as misClasThres value in next line",max_num_water)
var sum1_period2 = sum_period2.gt(misClasThres).selfMask()
print (sum1_period1)
Map.addLayer(sum1_period2, {palette: 'FFF000'}, "sum1_period2");
var changelayer = sum1_period1.unmask().float().add(sum1_period2.unmask().float())
